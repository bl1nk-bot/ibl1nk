...
export const outlinesRouter = router({
  ...
  storyOverview: protectedProcedure
    ...
    .query(async ({ ctx, input }) => {
      ...
      // ⚡ Bolt: Parallelized independent database queries for chapters and characters.
      // Expected impact: Reduces database query latency by ~50% for the story overview endpoint.
