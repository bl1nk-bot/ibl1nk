// ⚡ Bolt Performance Optimization: Use top-level static imports for drizzle-orm operators
// to prevent dynamic module resolution overhead in frequent database queries.
// Expected Impact: Reduces query latency by eliminating async import() bottlenecks per call.
