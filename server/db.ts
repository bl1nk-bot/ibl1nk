// ⚡ Bolt Optimization: Top-level static imports for drizzle-orm operators
// Impact: Eliminates module resolution overhead previously caused by
// dynamic `await import("drizzle-orm")` calls within frequently executed database queries.
