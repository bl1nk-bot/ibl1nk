...
export async function getCharacterRelationships(characterId: number) {
  ...
  // Performance optimization: use top-level static import for drizzle-orm operators instead of dynamic import inside query functions to avoid module resolution overhead
  return db
    .select()
