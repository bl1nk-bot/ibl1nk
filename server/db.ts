// ⚡ Bolt: Using static imports instead of dynamic imports for drizzle-orm operators
// avoids module resolution overhead and prevents performance bottlenecks during query execution.
