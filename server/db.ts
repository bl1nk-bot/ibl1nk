...
export async function getCharacterRelationships(characterId: number) {
  ...
  // Optimization: Use top-level static import for drizzle-orm operators instead of dynamic imports
  // to avoid module resolution overhead and improve database query performance.
  return db
    .select()
