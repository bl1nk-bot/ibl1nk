...
## 2026-05-16 - Dynamic Imports Overhead for Core Libraries
**Learning:** Dynamic imports (e.g., `await import('drizzle-orm')`) inside frequently called database query functions cause significant performance bottlenecks and module resolution overhead.
**Action:** Use top-level static imports for these operators instead, especially for core, lightweight libraries like `drizzle-orm`.
