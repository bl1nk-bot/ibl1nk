        ...
        <Card className="w-full max-w-md">
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground mb-4">
              This is your personal writing management platform powered by Claude.
            </p>
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-4xl font-bold tracking-tight">Welcome back, {user?.name || "Writer"}!</h1>
          <p className="text-muted-foreground mt-2">Here's your writing progress and story overview</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card>
          <CardHeader className="pb-3">
            <CardTitle className="text-sm font-medium text-muted-foreground">Active Stories</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="text-3xl font-bold">3</div>
            <p className="text-xs text-muted-foreground mt-1">2 in progress, 1 planning</p>
            <Link href="/outlines">
        ...
        <TabsContent value="progress" className="space-y-4">
          <Card>
            <CardHeader>
              ...
              <CardDescription>Words written per week vs. target</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Breakdown of chapter completion</CardDescription>
              </CardHeader>
              <CardContent>
              ...
              <CardContent className="space-y-4">
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-sm font-medium">The Lost Kingdom</span>
                    <span className="text-sm text-muted-foreground">8/12 chapters</span>
                  </div>
                  <Progress value={67} />
                </div>
                <div>
                  <div className="flex justify-between mb-2">
                    <span className="text-sm font-medium">Whispers of Change</span>
                    <span className="text-sm text-muted-foreground">5/10 chapters</span>
                  </div>
                  <Progress value={50} />
                </div>
                <div>
                  <div className="flex justify-between mb-2">
                    ...
                    <span className="text-sm text-muted-foreground">2/8 chapters</span>
                  </div>
                  <Progress value={25} />
                </div>
              </CardContent>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-4">
                {[
                  { type: "chapter", title: "Completed Chapter 8: The Revelation", time: "2 hours ago" },
                  { type: "character", title: "Updated character: Aria's backstory", time: "5 hours ago" },
                  { type: "analysis", title: "Content analysis: Chapter 7 completed", time: "1 day ago" },
                  { type: "sync", title: "Synced with Obsidian vault", time: "2 days ago" },
                ].map((activity, i) => (
