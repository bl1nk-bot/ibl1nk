...
const CategoryFilterControl: React.FC<CategoryFilterControlProps> = ({
  ...
  return (
    <div
      className={`mb-6 p-3 rounded-lg ${currentTheme.cardBg} bg-opacity-70 flex items-center gap-2 flex-wrap`}
    >
      <span
        className={`text-sm font-medium mr-2 ${currentTheme.text} opacity-90 flex items-center`}
      >
