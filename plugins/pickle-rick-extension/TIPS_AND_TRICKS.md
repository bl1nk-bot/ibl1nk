...
- **Rick (The Manager):** The main agent. He creates the plan, breaks down tickets, and **audits** the work. He does _not_ write the code himself in complex phases.
...
You can watch Pickle Rick's "thoughts" in real-time, but to see the _real_ coding progress, you need to watch the **Worker (Morty)** logs.
...
> "I'm not just a CLI tool, Morty. I'm the reason your code compiles! _belch_ Now get back to work!" 🥒
